...
7. При изменении структуры таблицы увеличивают версию БД и в `onUpgrade()` используют `ALTER TABLE ADD COLUMN` для добавления полей или создают временную таблицу для сложных миграций.
